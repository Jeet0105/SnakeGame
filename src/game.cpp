...
void Game::generateSpecialFood()
{
    ...
    if (!specialFoodActive)
    {
        ...
        specialFoodDuration = 50;               // total frames
        specialFoodTimer = specialFoodDuration; // Special food lasts for 50 frames (about 5 seconds at 10 FPS)
    }
}
...
void Game::run()
{
    ...
    while (running)
    {
        ...
        case PLAYING:
            update();
            renderer.render(snake, food, specialFood, specialFoodActive, specialFoodTimer, specialFoodDuration, score, highScore, false);
            break;
        case PAUSED:
            renderer.render(snake, food, specialFood, specialFoodActive, specialFoodTimer, specialFoodDuration, score, highScore, true);
            break;
        case GAME_OVER:
